...
class ClienteDAO {
    ...
    public static function inserir($cliente){
        $sql = "INSERT INTO clientes "
                . " ( id, nome, telefone, cpf, email, senha, "
                . "   foto, nomeCid, sexo, acesso ) VALUES "
                . " ( '".$cliente->getId()."' , "
                . "   '".$cliente->getNome()."' , "
                . "   '".$cliente->getTelefone()."' , "
                . "   '".$cliente->getCpf()."' , "
    ...
    public static function getClientes($sql = null){
        ...
        $sql = " SELECT c.id, c.nome, c.fone, c.cpf,"
             . " c.email, c.foto,c.nomeCid c.sexo"
             . " FROM clientes c "
             . " ORDER BY c.nome ";
        }
        $result = Conexao::consultar($sql);
        $lista = new ArrayObject();
        while( list( $id, $foto, $nome, $cpf, $telefone, $email,
